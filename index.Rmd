...
Serão considerados os anos de 1755 até 1923, realizando a previsnão utilizando os ultimos 10 anos
...
Podemos observar que existe muito pouca difereça entre as metricas de erro para os dados de treino em relação aos dados de teste. Podemos dizer que o modelo tem uma boa capacidade para prever dados futuros que não foram utilizados no ajuste.
...
Depois de varias tentativa de encontrar um melhor modelo para prever os ultimos 10 anos com um MAPE sendo o menor possivel encontrei um ARMA(6,5) para os dados com transformação Box-Cox
...
Vamos realizar testes de diagnósticos para avaliar o modelo ARMA(6,5) atravéz dos gráficos de autocorrelação e de autocorrelação parcial e também com o teste Ljung-Box
...
Vamos fazer a previsão dos dados da série de manchas solares para os ultimos 10 anos
...
df_pred %>% 
  ...
  labs(x = 'Ano', y = 'Manchas', title = 'Predizendo os ultimos 10 anos')
